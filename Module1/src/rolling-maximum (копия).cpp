...
public:
    ...
    void insert(ElementWithIndex<T> *element) override {
        ...
        Heap<ElementWithIndex<T> *, C>::insert(element);
    }
...
void testElementWithIndexHeap() {
    ...
    std::cout << "index: " << heap.getTop()->index << std::endl;
    for (int k = 0; k < 15; ++k) {
        std::cout << "index: " << arr[k].index << std::endl;
    }
